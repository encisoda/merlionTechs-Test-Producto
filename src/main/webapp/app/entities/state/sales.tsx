...
import { Translate, ICrudGetAllAction, ICrudPutAction } from 'react-jhipster';
...
export const Sales = (props: ISalesProps) => {
  ...
  salesList.forEach(element => ((element.state.toString()) === 'IN_CHARGE') && salesList1.push(element));

  return (
    <div>
      <h2 id="sales-heading">
        <div className="btn group">
          <Link to={`${match.url}`} className="btn btn-primary jh-create-entity" id="jh-create-entity">
            &nbsp;
            Encargados
          </Link>
        </div>
